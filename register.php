...
<body>
	<div class="wrapper">
		<form id="Register" class="center" action="login.php" method="POST">
			<?php 
				if(isset($_COOKIE['ERROR_LEVEL'])) echo "<span class=\"error-message\">".$_COOKIE['ERROR_MSG']."</span>";
			?>
			<span>
				<input class="pretty-input center" type="text" name="login" placeholder="Username">
				<span class="icon"><img class="icon" src="user.png"></img></span>
			</span>
			<span>
				<input class="pretty-input center" type="text" name="login" placeholder="E-mail">
				<span class="icon"><img class="icon" src="user.png"></img></span>
			</span>
			<span>
			...
			<span>
				<input class="pretty-input center" type="password" name="pass" placeholder="Repeat Password">
				<span class="icon"><img class="icon" src="pass.png"></img></span>
			</span>
			<span>
